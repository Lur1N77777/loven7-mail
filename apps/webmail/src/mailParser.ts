...
export function buildMailFrameSrcDoc(
  ...
  return `<!doctype html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><meta name="referrer" content="no-referrer"><meta http-equiv="Content-Security-Policy" content="default-src 'none'; ${imagePolicy} script-src 'none'; style-src 'unsafe-inline'; font-src data:; media-src data: blob:; object-src 'none'; form-action 'none'; base-uri 'none'"><base target="_blank"><style>html{margin:0;padding:0;width:100%;min-height:0;background:#fff;overflow:auto;}body{box-sizing:border-box;margin:0;width:100%;min-height:0;padding:18px;background:#fff;color:#172033;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Arial,sans-serif;font-size:15px;line-height:1.58;overflow:visible;overflow-wrap:anywhere;word-break:break-word;}#loven7-scale-root{display:block;width:100%;min-height:0;overflow:visible;}#loven7-render-root{display:flow-root;width:100%;min-width:0;min-height:0;overflow:visible;}#loven7-render-root>*{margin-left:auto!important;margin-right:auto!important;}a{color:#2563eb;text-decoration-thickness:.08em;text-underline-offset:2px;}img{max-width:100%!important;border:0;vertical-align:middle;}img:not([height]){height:auto!important;}img[data-blocked-src],img[data-blocked-srcset]:not([src]){display:inline-block;min-width:130px;padding:13px 15px;border:1px dashed #d8d2c8;border-radius:10px;background:#faf9f7;color:#8a857d;font-size:12px;line-height:1.5;}svg,video,canvas{max-width:100%!important;height:auto!important;}pre,code{white-space:pre-wrap;word-break:break-word;overflow-wrap:anywhere;}blockquote{margin-left:0;padding-left:14px;border-left:3px solid #dbe7ff;color:#42526b;}form[data-disabled-form='true']{opacity:.75;pointer-events:none;}@media(max-width:560px){body{padding:10px;font-size:14px;line-height:1.54;}p{margin-block:.72em;}}</style></head><body><div id="loven7-scale-root"><div id="loven7-render-root" class="loven7-render-root">${safeHtml}</div></div><style id="loven7-final-fit">html,body{max-width:100%!important;}#loven7-render-root img,#loven7-render-root svg,#loven7-render-root video,#loven7-render-root canvas{max-width:100%!important;}#loven7-render-root img:not([height]){height:auto!important;}#loven7-render-root pre,#loven7-render-root code{white-space:pre-wrap!important;overflow-wrap:anywhere!important;}</style></body></html>`;
}
