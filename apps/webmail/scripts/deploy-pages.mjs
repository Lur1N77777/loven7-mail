...
const projectName = (process.env.WEBMAIL_PAGES_PROJECT_NAME || '').trim();
...
if (!projectName) {
  console.error('WEBMAIL_PAGES_PROJECT_NAME is required. Set it to the exact Webmail Pages project you intend to deploy.');
  process.exit(1);
}
